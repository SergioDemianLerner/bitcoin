...
public:
    CMainParams() {
        ...
        consensus.HardForkTime = 1513209600; // Thu, 14 Dec 2017 00:00:00 GMT
        ...
        // Deployment of SegWit (BIP141, BIP143, and BIP147) plus a 2Mb hardfork later
...
public:
    CTestNetParams() {
        ...
        consensus.HardForkTime = -1; // Never
        consensus.powLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 10 * 60;
